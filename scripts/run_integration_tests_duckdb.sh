...
NEGATIVE_MACROS="assert_duplicate_column_rejected assert_duplicate_metric_rejected assert_duplicate_table_key_rejected assert_unknown_relationship_from_rejected assert_unknown_relationship_to_rejected assert_unknown_relationship_column_rejected assert_unknown_folder_column_rejected assert_unknown_folder_metric_rejected assert_unknown_filter_column_rejected assert_nonexistent_relation_rejected assert_duplicate_folder_rejected assert_duplicate_filter_rejected assert_duplicate_relationship_rejected assert_filter_options_reserved_key_rejected assert_alphanumeric_column_rejected assert_digit_token_column_rejected assert_unsupported_format_kind_rejected assert_unsupported_number_format_option_rejected assert_unsupported_datetime_format_option_rejected assert_duplicate_control_rejected assert_empty_control_targets_rejected assert_unknown_control_table_rejected assert_unknown_control_column_rejected assert_control_options_reserved_key_rejected"
